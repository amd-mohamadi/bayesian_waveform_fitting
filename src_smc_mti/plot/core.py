...
# Optional IO helpers (not present in this stripped-down repo)
try:
    ...
    def _missing(*args, **kwargs):
        raise ImportError("File IO helpers are not available in this build.")

    read_matlab_output = read_pickle_output = read_hyp_output = read_scatangle_output = _missing
    def _parser(*args, **kwargs):
        raise ImportError("Argument parser is not available in this build.")
try:
